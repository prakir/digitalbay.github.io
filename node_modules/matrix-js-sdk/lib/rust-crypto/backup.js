...
class RustBackupManager extends _typedEventEmitter.TypedEventEmitter {
  constructor(olmMachine, http, outgoingRequestProcessor) {
    ...
    (0, _defineProperty2.default)(this, "checkedForBackup", false);
    /**
     ...
     */
    (0, _defineProperty2.default)(this, "serverBackupInfo", undefined);
    (0, _defineProperty2.default)(this, "activeBackupVersion", null);
    (0, _defineProperty2.default)(this, "stopped", false);
    /** whether {@link backupKeysLoop} is currently running */
    (0, _defineProperty2.default)(this, "backupKeysLoopRunning", false);
    (0, _defineProperty2.default)(this, "keyBackupCheckInProgress", null);
