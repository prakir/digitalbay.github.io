...
async function initRustCrypto(args) {
  ...
  const storeHandle = await _matrixSdkCryptoWasm.StoreHandle.open((_args$storePrefix = args.storePrefix) !== null && _args$storePrefix !== void 0 ? _args$storePrefix : undefined, (_ref = args.storePrefix && args.storePassphrase) !== null && _ref !== void 0 ? _ref : undefined);
