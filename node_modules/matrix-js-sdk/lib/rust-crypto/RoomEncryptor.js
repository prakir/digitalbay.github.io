...
class RoomEncryptor {
  ...
  constructor(olmMachine, keyClaimManager, outgoingRequestManager, room, encryptionSettings) {
    ...
    (0, _defineProperty2.default)(this, "lazyLoadedMembersResolved", false);
    /**
     ...
     */
    (0, _defineProperty2.default)(this, "currentEncryptionPromise", Promise.resolve());
  ...
  encryptEvent(event, globalBlacklistUnverifiedDevices) {
    var _event$getTxnId;
    const logger = new _logger.LogSpan(this.prefixedLogger, event ? (_event$getTxnId = event.getTxnId()) !== null && _event$getTxnId !== void 0 ? _event$getTxnId : "" : "prepareForEncryption");
  ...
  async ensureEncryptionSession(logger, globalBlacklistUnverifiedDevices) {
    ...
    rustEncryptionSettings.onlyAllowTrustedDevices = (_this$room$getBlackli = this.room.getBlacklistUnverifiedDevices()) !== null && _this$room$getBlackli !== void 0 ? _this$room$getBlackli : globalBlacklistUnverifiedDevices;
