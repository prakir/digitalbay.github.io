...
class SyncApi {
  ...
  constructor(client, opts, syncOpts) {
    ...
    (0, _defineProperty2.default)(this, "prepareLazyLoadingForSync", async () => {
      ...
      if (this.opts.lazyLoadMembers) {
        ...
        (_this$syncOpts$crypto = this.syncOpts.crypto) === null || _this$syncOpts$crypto === void 0 || _this$syncOpts$crypto.enableLazyLoading();
      }
    });
    (0, _defineProperty2.default)(this, "storeClientOptions", async () => {
      try {
  ...
  async sync() {
    ...
    (_global$window = global.window) === null || _global$window === void 0 || (_global$window$addEve = _global$window.addEventListener) === null || _global$window$addEve === void 0 || _global$window$addEve.call(_global$window, "online", this.onOnline, false);
    if (this.client.isGuest()) {
  ...
  stop() {
    ...
    (_global$window2 = global.window) === null || _global$window2 === void 0 || (_global$window2$remov = _global$window2.removeEventListener) === null || _global$window2$remov === void 0 || _global$window2$remov.call(_global$window2, "online", this.onOnline, false);
    this.running = false;
  ...
  resolveInvites(room) {
    ...
    room.getMembersWithMembership(_membership.KnownMembership.Invite).forEach(function (member) {
      ...
      promise.then(function (info) {
        ...
        if ((inviteEvent === null || inviteEvent === void 0 ? void 0 : inviteEvent.getContent().membership) !== _membership.KnownMembership.Invite) {
  ...
  findEncryptionEvent(events) {
    return events === null || events === void 0 ? void 0 : events.find(e => e.getType() === _event.EventType.RoomEncryption && e.getStateKey() === "");
  }
