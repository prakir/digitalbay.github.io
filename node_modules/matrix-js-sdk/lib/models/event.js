...
class MatrixEvent extends _typedEventEmitter.TypedEventEmitter {
  ...
  constructor(event = {}) {
    ...
    */
    ...
    (0, _defineProperty2.default)(this, "_decryptionFailureReason", null);
  ...
  getDetails() {
    ...
    if (room) {
      var _this$getDate;
      // in-room event
      return `id=${this.getId()} type=${this.getWireType()} sender=${this.getSender()} room=${room} ts=${(_this$getDate = this.getDate()) === null || _this$getDate === void 0 ? void 0 : _this$getDate.toISOString()}`;
    } else {
      // to-device event
  ...
  getMembershipAtEvent() {
    const unsigned = this.getUnsigned();
    if (typeof unsigned[_event.UNSIGNED_MEMBERSHIP_FIELD.name] === "string") {
      return unsigned[_event.UNSIGNED_MEMBERSHIP_FIELD.name];
    } else {
      return undefined;
    }
  }
  ...
  moveAllRelatedToMainTimeline(room) {
    ...
    if (thread) {
      for (const event of thread.events) {
        ...
        if (((_event$getRelation = event.getRelation()) === null || _event$getRelation === void 0 ? void 0 : _event$getRelation.event_id) === this.getId()) {
  ...
  isRelation(relType) {
    ...
    const relation = (_this$getWireContent3 = this.getWireContent()) === null || _this$getWireContent3 === void 0 ? void 0 : _this$getWireContent3["m.relates_to"];
    if (this.isState() && !!(relation !== null && relation !== void 0 && relation.rel_type) && [_event.RelationType.Replace, _event.RelationType.Thread].includes(relation.rel_type)) {
