...
class RoomReceipts {
  constructor(room) {
     ...
     */
    (0, _defineProperty2.default)(this, "onTimelineEvent", event => {
  ...
  userSentLatestEventInThread(threadId, userId) {
    ...
    const timeline = threadId === _read_receipts.MAIN_ROOM_TIMELINE ? this.room.getLiveTimeline().getEvents() : (_this$room$getThread = this.room.getThread(threadId)) === null || _this$room$getThread === void 0 ? void 0 : _this$room$getThread.timeline;
