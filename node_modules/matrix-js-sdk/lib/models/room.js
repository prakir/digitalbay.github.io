...
class Room extends _readReceipt.ReadReceipt {
  ...
  constructor(roomId, client, myUserId, opts = {}) {
     ...
     * (and unthreaded).
     */
    (0, _defineProperty2.default)(this, "roomReceipts", new _roomReceipts.RoomReceipts(this));
  ...
  getMyMembership() {
    ...
    return (_this$selfMembership = this.selfMembership) !== null && _this$selfMembership !== void 0 ? _this$selfMembership : _membership.KnownMembership.Leave;
  }
  ...
  getAvatarFallbackMember() {
    ...
    const nonFunctionalHeroes = (_this$summaryHeroes2 = this.summaryHeroes) === null || _this$summaryHeroes2 === void 0 ? void 0 : _this$summaryHeroes2.filter(h => !functionalMembers.includes(h));
    ...
    const nonFunctionalMembers = members === null || members === void 0 ? void 0 : members.filter(m => !functionalMembers.includes(m.userId));
  ...
  async loadMembersFromServer() {
    ...
    const response = await this.client.members(this.roomId, undefined, _membership.KnownMembership.Leave, lastSyncToken !== null && lastSyncToken !== void 0 ? lastSyncToken : undefined);
  ...
  clearNotificationsOnReceipt(event) {
    ...
    for (const threadId of threadIds) {
      ...
      const maxHistory = 20;
      const timeline = threadId === "main" ? this.getLiveTimeline() : (_this$getThread = this.getThread(threadId)) === null || _this$getThread === void 0 ? void 0 : _this$getThread.liveTimeline;
      if (!timeline) {
  ...
  getMxcAvatarUrl() {
    ...
    return ((_this$currentState$ge = this.currentState.getStateEvents(_event2.EventType.RoomAvatar, "")) === null || _this$currentState$ge === void 0 || (_this$currentState$ge = _this$currentState$ge.getContent()) === null || _this$currentState$ge === void 0 ? void 0 : _this$currentState$ge.url) || null;
  }
  ...
  async fetchRoomThreads() {
    ...
    if (_thread.Thread.hasServerSideListSupport) {
      ...
      for (const rootEvent of threadRoots) {
        ...
        (_this$threadsTimeline3 = this.threadsTimelineSets[0]) === null || _this$threadsTimeline3 === void 0 || _this$threadsTimeline3.addLiveEvent(rootEvent, opts);
        ...
        if (threadRelationship !== null && threadRelationship !== void 0 && threadRelationship.current_user_participated) {
          ...
          (_this$threadsTimeline4 = this.threadsTimelineSets[1]) === null || _this$threadsTimeline4 === void 0 || _this$threadsTimeline4.addLiveEvent(rootEvent, opts);
  ...
  async processPollEvent(event) {
    ...
    if (relationEventId && this.polls.has(relationEventId)) {
      ...
      poll === null || poll === void 0 || poll.onNewRelation(event);
    }
  }
  ...
  onThreadDelete(thread) {
    ...
    const roomEvent = timeline === null || timeline === void 0 || (_timeline$getEvents = timeline.getEvents()) === null || _timeline$getEvents === void 0 ? void 0 : _timeline$getEvents.find(it => it.getId() === thread.id);
    if (roomEvent) {
  ...
  async addLiveEvents(events, duplicateStrategyOrOpts, fromCache = false) {
    ...
    for (const event of events) {
      ...
      (_eventsByThread2 = eventsByThread[(_threadId3 = threadId) !== null && _threadId3 !== void 0 ? _threadId3 : ""]) === null || _eventsByThread2 === void 0 || _eventsByThread2.push(event);
      if (shouldLiveInRoom) {
  ...
  hasEncryptionStateEvent() {
    ...
    return Boolean((_this$getLiveTimeline = this.getLiveTimeline().getState(_eventTimeline.EventTimeline.FORWARDS)) === null || _this$getLiveTimeline === void 0 ? void 0 : _this$getLiveTimeline.getStateEvents(_event2.EventType.RoomEncryption, ""));
  }
}
