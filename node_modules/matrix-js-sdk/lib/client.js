...
class MatrixClient extends _typedEventEmitter.TypedEventEmitter {
  ...
  constructor(opts) {
    var _opts$logger, _opts$usingExternalCr, _opts$cryptoCallbacks;
    super();
    ...
    (0, _defineProperty2.default)(this, "startMatrixRTC", () => {
      if (this.isInitialSyncComplete()) {
    ...
    this.logger = (_opts$logger = opts.logger) !== null && _opts$logger !== void 0 ? _opts$logger : _logger.logger;
  ...
  async initRustCrypto({
    ...
    const rustCrypto = await RustCrypto.initRustCrypto({
      ...
      legacyPickleKey: (_this$pickleKey = this.pickleKey) !== null && _this$pickleKey !== void 0 ? _this$pickleKey : "DEFAULT_KEY",
  ...
  async sendSharedHistoryKeys(roomId, userIds) {
    ...
    const roomEncryption = (_this$crypto4 = this.crypto) === null || _this$crypto4 === void 0 ? void 0 : _this$crypto4.getRoomEncryption(roomId);
    if (!roomEncryption) {
  ...
  async joinRoom(roomIdOrAlias, opts = {}) {
    ...
    if (room !== null && room !== void 0 && room.hasMembershipState(this.credentials.userId, _membership.KnownMembership.Join)) return room;
    ...
    if (resolvedRoom !== null && resolvedRoom !== void 0 && resolvedRoom.hasMembershipState(this.credentials.userId, _membership.KnownMembership.Join)) return resolvedRoom;
  ...
  knockRoom(roomIdOrAlias, opts = {}) {
    const room = this.getRoom(roomIdOrAlias);
    if (room !== null && room !== void 0 && room.hasMembershipState(this.credentials.userId, _membership.KnownMembership.Knock)) {
  ...
  async setPowerLevel(roomId, userId, powerLevel) {
    ...
    if (this.clientRunning && this.isInitialSyncComplete()) {
      var _this$getRoom;
      content = (_this$getRoom = this.getRoom(roomId)) === null || _this$getRoom === void 0 || (_this$getRoom = _this$getRoom.currentState) === null || _this$getRoom === void 0 || (_this$getRoom = _this$getRoom.getStateEvents(_event2.EventType.RoomPowerLevels, "")) === null || _this$getRoom === void 0 ? void 0 : _this$getRoom.getContent();
    }
    if (!content) {
      try {
  ...
  sendEvent(roomId, threadIdOrEventType, eventTypeOrContent, contentOrTxnId, txnIdOrVoid) {
    ...
    if (threadId && !((_mRelates_to = content["m.relates_to"]) !== null && _mRelates_to !== void 0 && _mRelates_to.rel_type)) {
      var _mRelates_to2, _this$getRoom2;
      ...
      const thread = (_this$getRoom2 = this.getRoom(roomId)) === null || _this$getRoom2 === void 0 ? void 0 : _this$getRoom2.getThread(threadId);
      if (thread && !isReply) {
  ...
  sendCompleteEvent(roomId, threadId, eventObject, txnId) {
    ...
    room === null || room === void 0 || room.reEmitter.reEmit(localEvent, [_event.MatrixEventEvent.BeforeRedaction]);
    ...
    if (targetId !== null && targetId !== void 0 && targetId.startsWith("~")) {
      ...
      target === null || target === void 0 || target.once(_event.MatrixEventEvent.LocalEventIdReplaced, () => {
  ...
  async setRoomReadMarkers(roomId, rmEventId, rrEvent, rpEvent) {
    ...
    if (rrEvent) {
      ...
      room === null || room === void 0 || room.addLocalEchoReceipt(this.credentials.userId, rrEvent, _read_receipts.ReceiptType.Read);
    }
    ...
    if (rpEvent) {
      ...
      room === null || room === void 0 || room.addLocalEchoReceipt(this.credentials.userId, rpEvent, _read_receipts.ReceiptType.ReadPrivate);
    }
  ...
  async inviteByThreePid(roomId, medium, address) {
    ...
    if ((_this$identityServer = this.identityServer) !== null && _this$identityServer !== void 0 && _this$identityServer.getAccessToken) {
  ...
  async setSyncPresence(presence) {
    var _this$syncApi4;
    (_this$syncApi4 = this.syncApi) === null || _this$syncApi4 === void 0 || _this$syncApi4.setPresence(presence);
  }
    ...
    if (isNotifTimeline) {
      ...
      promise = this.fetchRelations((_eventTimeline$getRoo2 = eventTimeline.getRoomId()) !== null && _eventTimeline$getRoo2 !== void 0 ? _eventTimeline$getRoo2 : "", thread.id, null, null, {
        ...
        if (!newToken && backwards) {
          ...
          const originalEvent = (_thread$rootEvent = thread.rootEvent) !== null && _thread$rootEvent !== void 0 ? _thread$rootEvent : mapper(await this.fetchRoomEvent((_eventTimeline$getRoo3 = eventTimeline.getRoomId()) !== null && _eventTimeline$getRoo3 !== void 0 ? _eventTimeline$getRoo3 : "", thread.id));
  ...
  getCrossSigningCacheCallbacks() {
    var _this$crypto5;
    // XXX: Private member access
    return (_this$crypto5 = this.crypto) === null || _this$crypto5 === void 0 ? void 0 : _this$crypto5.crossSigningInfo.getCacheCallbacks();
  }
  ...
  async logout(stopClient = false) {
    var _this$crypto6;
    if ((_this$crypto6 = this.crypto) !== null && _this$crypto6 !== void 0 && (_this$crypto6 = _this$crypto6.backupManager) !== null && _this$crypto6 !== void 0 && _this$crypto6.getKeyBackupEnabled()) {
      try {
  ...
  async createRoom(options) {
    ...
    if (invitesNeedingToken.length > 0 && (_this$identityServer2 = this.identityServer) !== null && _this$identityServer2 !== void 0 && _this$identityServer2.getAccessToken) {
      const identityAccessToken = await this.identityServer.getAccessToken();
      if (identityAccessToken) {
  ...
  submitMsisdnToken(sid, clientSecret, msisdnToken, identityAccessToken) {
    ...
    return this.http.idServerRequest(_httpApi.Method.Post, "/validate/msisdn/submitToken", params, _httpApi.IdentityPrefix.V2, identityAccessToken !== null && identityAccessToken !== void 0 ? identityAccessToken : undefined);
  }
  ...
  unstableGetFileTreeSpace(roomId) {
    ...
    const room = this.getRoom(roomId);
    if ((room === null || room === void 0 ? void 0 : room.getMyMembership()) !== _membership.KnownMembership.Join) return null;
  ...
  supportsThreads() {
    ...
    return ((_this$clientOpts7 = this.clientOpts) === null || _this$clientOpts7 === void 0 ? void 0 : _this$clientOpts7.threadSupport) || false;
  }
