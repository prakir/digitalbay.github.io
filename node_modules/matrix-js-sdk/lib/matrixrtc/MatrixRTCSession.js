...
class MatrixRTCSession extends _typedEventEmitter.TypedEventEmitter {
    ...
    for (const memberEvent of callMemberEvents) {
      ...
      for (const membershipData of eventMemberships) {
        try {
          ...
          if (!room.hasMembershipState((_membership$sender = membership.sender) !== null && _membership$sender !== void 0 ? _membership$sender : "", _membership.KnownMembership.Join)) {
  ...
  constructor(client, room, memberships) {
    ...
    (0, _defineProperty2.default)(this, "setNewKeyTimeouts", new Set());
    (0, _defineProperty2.default)(this, "updateCallMembershipRunning", false);
    (0, _defineProperty2.default)(this, "needCallMembershipUpdate", false);
    (0, _defineProperty2.default)(this, "manageMediaKeys", false);
    // userId:deviceId => array of keys
    (0, _defineProperty2.default)(this, "encryptionKeys", new Map());
    /**
     * Re-sends the encryption keys room event
     */
    (0, _defineProperty2.default)(this, "sendEncryptionKeysEvent", async () => {
      ...
      try {
        ...
        if (this.keysEventUpdateTimeout === undefined) {
          ...
          const resendDelay = (_matrixError$data$ret = (_matrixError$data = matrixError.data) === null || _matrixError$data === void 0 ? void 0 : _matrixError$data.retry_after_ms) !== null && _matrixError$data$ret !== void 0 ? _matrixError$data$ret : 5000;
    ...
    (0, _defineProperty2.default)(this, "onCallEncryption", event => {
    ...
    (0, _defineProperty2.default)(this, "onMembershipUpdate", () => {
    ...
    (0, _defineProperty2.default)(this, "triggerCallMembershipEventUpdate", async () => {
    ...
    (0, _defineProperty2.default)(this, "onRotateKeyTimeout", () => {
    ...
    roomState === null || roomState === void 0 || roomState.on(_roomState.RoomStateEvent.Members, this.onMembershipUpdate);
    this.setExpiryTimer();
  }
  ...
  async stop() {
    ...
    const roomState = this.room.getLiveTimeline().getState(_eventTimeline.EventTimeline.FORWARDS);
    roomState === null || roomState === void 0 || roomState.off(_roomState.RoomStateEvent.Members, this.onMembershipUpdate);
  }
  ...
  setEncryptionKey(userId, deviceId, encryptionKeyIndex, encryptionKeyString, delayBeforeuse = false) {
    ...
    const encryptionKeys = (_this$encryptionKeys$ = this.encryptionKeys.get(participantId)) !== null && _this$encryptionKeys$ !== void 0 ? _this$encryptionKeys$ : [];
  ...
  async updateCallMembershipEvent() {
    ...
    const myCallMemberEvent = (_roomState$getStateEv = roomState.getStateEvents(_event.EventType.GroupCallMemberPrefix, localUserId)) !== null && _roomState$getStateEv !== void 0 ? _roomState$getStateEv : undefined;
    const content = (_myCallMemberEvent$ge = myCallMemberEvent === null || myCallMemberEvent === void 0 ? void 0 : myCallMemberEvent.getContent()) !== null && _myCallMemberEvent$ge !== void 0 ? _myCallMemberEvent$ge : {};
