...
class MSC3906Rendezvous {
  ...
  async verifyAndCrossSignDevice(deviceInfo) {
    ...
    const masterPublicKey = (_await$crypto$getCros = await crypto.getCrossSigningKeyId(_cryptoApi.CrossSigningKey.Master)) !== null && _await$crypto$getCros !== void 0 ? _await$crypto$getCros : undefined;
