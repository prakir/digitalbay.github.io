...
class Crypto extends _typedEventEmitter.TypedEventEmitter {
   ...
   */
  constructor(baseApis, _userId, deviceId, clientStore, cryptoStore, verificationMethods) {
    super();
    ...
    this.crossSigningInfo = new _CrossSigning.CrossSigningInfo(_userId, cryptoCallbacks, cacheCallbacks);
  ...
  async getActiveSessionBackupVersion() {
    if (this.backupManager.getKeyBackupEnabled()) {
      var _this$backupManager$v;
      return (_this$backupManager$v = this.backupManager.version) !== null && _this$backupManager$v !== void 0 ? _this$backupManager$v : null;
    }
    return null;
  }
  ...
  async checkOwnCrossSigningTrust({
    ...
    if (allowPrivateKeyRequests && (selfSigningChanged || selfSigningExistsNotLocallyCached)) {
      ...
      try {
        ...
        var _signing3;
        (_signing3 = signing) === null || _signing3 === void 0 || _signing3.free();
      }
      const device = this.deviceList.getStoredDevice(this.userId, this.deviceId);
      const signedDevice = await this.crossSigningInfo.signDevice(this.userId, device);
    ...
    if (allowPrivateKeyRequests && (userSigningChanged || userSigningExistsNotLocallyCached)) {
      ...
      try {
        ...
        var _signing4;
        (_signing4 = signing) === null || _signing4 === void 0 || _signing4.free();
      }
    }
    if (masterChanged) {
  ...
  onRoomMembership(event, member, oldMembership) {
    ...
    if (roomId in this.roomDeviceTrackingState) {
      ...
      } else if (member.membership == _membership.KnownMembership.Invite && (_this$clientStore$get = this.clientStore.getRoom(roomId)) !== null && _this$clientStore$get !== void 0 && _this$clientStore$get.shouldEncryptForInvitedMembers()) {
