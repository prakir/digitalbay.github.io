...
import { ClientEvent, ICrossSigningKey, IKeysUploadResponse, IUploadKeySignaturesResponse, MatrixClient } from "../client";
...
import { AddSecretStorageKeyOpts, SecretStorageKeyDescription, SecretStorageKeyObject, SecretStorageKeyTuple } from "../secret-storage";
import { ISecretRequest } from "./SecretSharing";
import { BackupTrustInfo, BootstrapCrossSigningOpts, CrossSigningStatus, DeviceVerificationStatus, EventEncryptionInfo, ImportRoomKeysOpts, KeyBackupCheck, KeyBackupInfo, OwnDeviceKeys, VerificationRequest as CryptoApiVerificationRequest } from "../crypto-api";
import { DeviceMap } from "../models/device";
export type { BootstrapCrossSigningOpts as IBootstrapCrossSigningOpts, CryptoCallbacks as ICryptoCallbacks, } from "../crypto-api";
/**
...
export declare class Crypto extends TypedEventEmitter<CryptoEvent, CryptoEventHandlerMap> implements CryptoBackend {
     ...
     */
    setDeviceVerification(userId: string, deviceId: string, verified?: boolean | null, blocked?: boolean | null, known?: boolean | null, keys?: Record<string, string>): Promise<DeviceInfo | CrossSigningInfo | ICrossSigningKey | undefined>;
