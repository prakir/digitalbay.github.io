...
class BackupManager {
  ...
  async deleteAllKeyBackupVersions() {
    var _await$this$baseApis$, _await$this$baseApis$2;
    // there could be several backup versions, delete all to be safe.
    let current = (_await$this$baseApis$ = (_await$this$baseApis$2 = await this.baseApis.getKeyBackupVersion()) === null || _await$this$baseApis$2 === void 0 ? void 0 : _await$this$baseApis$2.version) !== null && _await$this$baseApis$ !== void 0 ? _await$this$baseApis$ : null;
    while (current != null) {
      var _await$this$baseApis$3, _await$this$baseApis$4;
      await this.deleteKeyBackupVersion(current);
      this.disableKeyBackup();
      current = (_await$this$baseApis$3 = (_await$this$baseApis$4 = await this.baseApis.getKeyBackupVersion()) === null || _await$this$baseApis$4 === void 0 ? void 0 : _await$this$baseApis$4.version) !== null && _await$this$baseApis$3 !== void 0 ? _await$this$baseApis$3 : null;
    }
  }
  ...
  async checkAndStart() {
    ...
    let backupInfo;
    try {
      var _await$this$baseApis$5;
      backupInfo = (_await$this$baseApis$5 = await this.baseApis.getKeyBackupVersion()) !== null && _await$this$baseApis$5 !== void 0 ? _await$this$baseApis$5 : undefined;
    } catch (e) {
