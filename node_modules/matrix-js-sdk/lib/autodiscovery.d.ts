...
export declare enum AutoDiscoveryError {
    ...
    HomeserverTooOld = "The homeserver does not meet the version requirements"
}
...
export declare class AutoDiscovery {
    ...
    static readonly ERROR_HOMESERVER_TOO_OLD = AutoDiscoveryError.UnsupportedHomeserverSpecVersion;
