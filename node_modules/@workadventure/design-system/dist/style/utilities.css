...
.brick-feature .brick-feature-text {
  margin: auto;
  flex-basis: 100%;
  padding: 2rem;
  text-align: center
...
.brick .brick-feature .brick-feature-text_title {
 ...
 .brick .brick-feature .brick-feature-text_title svg {
  width: 100%;
  text-align: center
}
...
.brick-feature .brick-feature-image {
  ...
  border-style: solid;
  --tw-border-opacity: 1;
  border-color: hsl(var(--neutral-300) / var(--tw-border-opacity));
  text-align: left
}
...
.brick-feature .brick-feature-image.no-border {
  border-style: none
}

.brick-feature .brick-feature-image video {
  height: 100%;
  width: 100%;
  object-fit: cover
}

.brick-feature .brick-feature-image > .img-brick {
  display: none;
  height: auto
}
...
.brick-feature .brick-feature-image > .img-brick-mobile {
  display: block
}
